...
namespace Lab04_TicTacToe.Classes
{
	public class Player
    {
		...
		/// <summary>
		/// GetPosition is a Method used to get the location from the user
		/// </summary>
		...
		/// <summary>
		/// PositionForNumber Method used to convert the integer input (Numbers 1-9 ) to Position object for game board
		/// </summary>
		/// <param name="position"></param>
		/// <returns>Return the Position object depends on the  user input</returns>
		...
		/// <summary>
		///  Prompts the turn for a player and checks if the position is already occupied or not 
		/// </summary>
		/// <param name="board"></param>
		//no returning value (void function)
		public void TakeTurn(Board board)
		{
			...
			else
			{
				...
				board.DisplayBoard();  //disply board
				TakeTurn(board);  // try again
			}
		}
	}
}
